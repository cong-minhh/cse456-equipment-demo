...
public class StudentController {
     ...
     * 1. Gõ trực tiếp
     * - Khi gõ trực tiếp link /students nếu hàm xử lý có @RequestParam thì sẽ bị
    ...
    // Hàm xử lý cho url /student/form, khi người dùng bấm save trên form bằng Post
    // method
    @PostMapping("/student/form")
    public String saveStudent(@Valid @ModelAttribute("student") Student s, BindingResult result, Model model,
