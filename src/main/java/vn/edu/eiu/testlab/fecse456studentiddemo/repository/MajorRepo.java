...
/**
 * JpaRepository là interface trong spring data jpa. Chứa tất cả các hàm
 * abstract xử lý CRUD trên database.
 * Lúc kế thừa sẽ truyền vào tên class entity và kiểu dữ liệu của khóa chính
 * Trong JpaRepository đã xây dựng sẵn các phương thức abstract tự sinh hầu như
 * là phục vụ được các truy xuất cơ bản xuống db.
 */
